...
from pdf2zh_next.config.model import service_supports_glossary
...
def _create_translator_instance(
    ...
    for metadata in TRANSLATION_ENGINE_METADATA:
        if isinstance(translator_config, metadata.setting_model_type):
            ...
            has_glossary = bool(
                get_effective_glossary_paths(
                    settings.translation.glossaries,
                    settings.translation.disable_builtin_fashion_glossary,
            ...
            if (
                ...
                and has_glossary
                and not service_supports_glossary(
