...
> [!CAUTION]
>
> The current repository does not yet have a finalized public workflow for large-scale documentation internationalization. Therefore, PRs that only change translated documentation may be paused until the release process is stabilized.
>
> Please do NOT submit translation-only PRs until the repository maintainer publishes a stable translation contribution process.
...
3. Issues explicitly marked as "No help needed" in this repository or in referenced upstream project discussions.
4. Other contributions deemed inappropriate by the current repository maintainer(s).
...
## PRs that are recommended to discuss via Issue before submission

For the following types of PRs, it is recommended to discuss with the current repository maintainer(s) first before submission:
...
6. Create a PR on GitHub, provide a detailed description, and request a review from the current repository maintainer(s).
...
>
> If you have any questions about the source code or related matters, please open an issue or PR discussion in this repository.
>
> Resource files for version 2.0 are shared with [BabelDOC](https://github.com/funstory-ai/BabelDOC). The code for downloading related resources is in BabelDOC. If you want to add new resource files, please open an issue in this repository first.
...
> - Translators that have been discontinued by their upstream projects (such as deeplx)
...
>
> When you are unsure whether a translator meets the requirements, you can open an issue to discuss it with the current repository maintainer(s).
...
If you have any questions, please submit feedback via Issues or PR discussions in this repository. Thank you for your contribution!
