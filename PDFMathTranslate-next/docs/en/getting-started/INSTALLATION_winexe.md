...
***Step 1*** | Download `pdf2zh-<version>-with-assets-win64.zip` from your own GitHub Releases page.
...
> [!NOTE]
> **Portable Windows folder for this fashion-oriented branch**
>
> - If you need a desktop-portable build for apparel documents, run `script/build_fashion_portable.ps1` from the source tree.
> - By default the portable builder prefers the sibling `..\BabelDOC` source tree, so local builds stay on your stable `BabelDOC 0.6.3` checkout.
