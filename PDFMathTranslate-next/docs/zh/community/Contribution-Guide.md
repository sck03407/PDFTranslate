...
> [!CAUTION]
>
> 当前仓库尚未最终确定公开版的大规模文档国际化流程。因此，仅修改翻译文档的 PR 可能会在发布流程稳定前暂缓接受。
>
> 在仓库维护者发布稳定的翻译协作流程之前，请先不要提交“仅修改翻译文档”的 PR。
...
3. 当前仓库或引用的上游项目讨论中，明确标记为“无需帮助”的 Issue。
4. 当前仓库维护者认为不合适的其他贡献。
5. 贡献文档，但修改非英语语言的文档。
6. 需要修改 PDF 文件的 PR。
...
6. 在 GitHub 上创建一个 PR，提供详细描述，并请求当前仓库维护者进行审查。
7. 确保所有自动化检查通过。
...
>
> 如果你对源代码或相关事宜有任何疑问，请直接在当前仓库中发起 Issue 或 PR 讨论。
>
> 2.0 版本的资源文件与 [BabelDOC](https://github.com/funstory-ai/BabelDOC) 共享。下载相关资源的代码在 BabelDOC 中。如果你想添加新的资源文件，请先在当前仓库提交 Issue 讨论。
...
> - 基于逆向工程 API 的翻译器
>
> 当你不确定某个翻译器是否符合要求时，可以提交 issue 与当前仓库维护者讨论。
...
如果您有任何疑问，请通过当前仓库的 Issue 或 PR 讨论区提交反馈。感谢您的贡献！
